...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($loginResult === true) {
        ...
        if ($userProfile == $profile || $userProfile == 1) {
            header('Location: ./menus/MenuCocina.php');
            exit();
        } else {
...
<body class="cocina-bg">
    
    <!-- Encabezado Base1 -->
    <?php include '../view/bases/base1.php'; ?>

    <div class="form-container">
        <form action="loginCocina.php" method="POST" class="needs-validation" novalidate>
            <a href="../index.php" class="back-icon"><i class="fa-solid fa-circle-arrow-left"></i></a>
            <h2>Inicio Sesión Cocina</h2>
