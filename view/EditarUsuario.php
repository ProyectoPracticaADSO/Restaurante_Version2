...
<body>
  ...
  <div class="container mt-5 position-relative w-25">
    ...
    <form id="editForm" action="../controller/userController.php?action=editar" method="POST" class="needs-validation" novalidate>
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          ...
          <select class="form-control" id="tipo_documento" name="tipo_documento" required>
            ...
            <option value="CC" <?= $usuario['cedula_usuario'] == 'CC' ? 'selected' : '' ?>>CC</option>
            <option value="TI" <?= $usuario['cedula_usuario'] == 'TI' ? 'selected' : '' ?>>TI</option>
            <option value="CE" <?= $usuario['cedula_usuario'] == 'CE' ? 'selected' : '' ?>>CE</option>
            <option value="PAS" <?= $usuario['cedula_usuario'] == 'PAS' ? 'selected' : '' ?>>PAS</option>
          </select>
      ...
      <div class="form-group col-md-6">
        <label for="numero_telefono">Número contacto:</label>
        <input type="text" class="form-control" id="numero_telefono" value="<?= $usuario['numero_telefono'] ?>" name="numero_telefono" pattern="\d+" required>
        <div class="invalid-feedback">Por favor ingrese el número (solo números).</div>
      </div>
