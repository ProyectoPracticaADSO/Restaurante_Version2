...
<head>
  ...
  <style>
    ...
    .header-space {
      padding-top: 80px;
      /* Ajusta esto a la altura de tu header fijo */
    }
...
<body>
  ...
  <div class="container mt-5 position-relative">
    ...
    if (isset($_GET['error']) && $_GET['error'] == 'campos') {
      ...
      echo '<div class="alert alert-warning">La cédula ya existe.</div>';
    ...
    <div class="mx-auto" style="max-width: 800px;">
      <form id="formAgregarUsuario" action="../controller/userController.php?action=agregar" method="POST" class="needs-validation" novalidate>
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="numero_telefono" name="numero_telefono" pattern="\d+" required>
            <div class="invalid-feedback">Por favor ingrese el número (solo números).</div>
          </div>
        </div>
        ...
        <div class="text-center mt-4">
          <button type="submit" class="btn btn-warning px-5">Agregar Empleado</button>
        </div>
      </form>
    </div>
  </div>
